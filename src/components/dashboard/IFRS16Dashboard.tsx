        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              {metrics.activeContracts} ativos
            </p>
          </CardContent>
        </Card>
              ...
              <div key={contract.id} className="flex items-center justify-between p-4 border rounded-lg">
                <div className="flex-1">
                  ...
                  <div className="mt-1 flex items-center gap-4 text-sm text-gray-600">
                    ...
                    <span className={`flex items-center gap-1 ${getComplianceColor(contract.complianceStatus)}`}>
                      <CheckCircleIcon className="h-3 w-3" />
                      {contract.complianceStatus === 'compliant' ? 'Conforme' : 
                       contract.complianceStatus === 'warning' ? 'Atenção' : 'Erro'}
                    </span>
                  </div>
                </div>
