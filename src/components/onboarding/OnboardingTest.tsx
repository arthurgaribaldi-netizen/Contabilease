  ...
  return (
    <div className='p-6 bg-white rounded-lg shadow-lg max-w-2xl mx-auto'>
      ...
      <div className='space-y-4 mb-6'>
        ...
        <div className='space-y-2'>
          <div className='flex items-center justify-between p-3 bg-gray-50 rounded-lg'>
            ...
            <span
              className={`text-sm font-medium ${onboardingState.hasCompletedOptimizedOnboarding ? 'text-green-600' : 'text-gray-500'}`}
            >
          ...
          <div className='flex items-center justify-between p-3 bg-gray-50 rounded-lg'>
            ...
            <span
              className={`text-sm font-medium ${onboardingState.firstVictoryAchieved ? 'text-green-600' : 'text-gray-500'}`}
            >
      ...
      <div className='flex space-x-3'>
        ...
        <Button onClick={handleResetOnboarding} variant='outline' className='flex-1'>
      ...
      {isTestOpen && (
        <OptimizedOnboarding
          ...
          onFirstVictory={() => {
            logger.info('Primeira vitória alcançada!', {
              component: 'onboarding',
              operation: 'onFirstVictory',
            });
          }}
        />
      )}
