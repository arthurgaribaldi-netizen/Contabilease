...
export default function OptimizedOnboarding({ isOpen, onClose, onComplete, onFirstVictory }: OptimizedOnboardingProps) {
  ...
  const calculateContract = () => {
    try {
      if (!contractData.lease_start_date || !contractData.lease_end_date || !contractData.monthly_payment) {
        showError('Dados Incompletos', 'Preencha pelo menos: data de início, data de fim e valor mensal');
        return;
      }
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) => setCompanyData(prev => ({ ...prev, monthlyContracts: e.target.value }))}
                        className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                      >
                        <option value="">Selecione...</option>
            ...
            {currentStep === 1 && (
              <div className="space-y-6">
                <div className="text-center">
                  ...
                  <p className="text-gray-600">Crie seu primeiro contrato e veja a mágica acontecer</p>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => setContractData(prev => ({ ...prev, monthly_payment: Number(e.target.value) }))}
                          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                          placeholder="1500"
                        />
                      </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => setContractData(prev => ({ ...prev, lease_start_date: e.target.value }))}
                          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                        />
                      </div>
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => setContractData(prev => ({ ...prev, lease_end_date: e.target.value }))}
                          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                        />
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => setContractData(prev => ({ ...prev, lease_term_months: Number(e.target.value) }))}
                          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                          placeholder="36"
                        />
                      </div>
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => setContractData(prev => ({ ...prev, discount_rate_annual: Number(e.target.value) }))}
                          className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                          placeholder="8.5"
                        />
                      </div>
                    ...
                    <button
                      ...
                      disabled={!contractData.title || !contractData.monthly_payment || !contractData.lease_start_date || !contractData.lease_end_date}
                    ...
                    {showCalculation && calculationResult ? (
                      <div className="space-y-4">
                        ...
                        <div className="bg-green-50 p-4 rounded-lg space-y-3">
                          <div className="flex justify-between">
                            ...
                            <span className="font-medium text-green-800">
                              R$ {calculationResult.lease_liability_initial.toLocaleString('pt-BR', { minimumFractionDigits: 2 })}
                            </span>
                          </div>
                          ...
                          <div className="flex justify-between">
                            ...
                            <span className="font-medium text-green-800">
                              R$ {calculationResult.right_of_use_asset_initial.toLocaleString('pt-BR', { minimumFractionDigits: 2 })}
                            </span>
                          </div>
                          ...
                          <div className="flex justify-between">
                            ...
                            <span className="font-medium text-green-800">
                              R$ {calculationResult.monthly_interest_expense.toLocaleString('pt-BR', { minimumFractionDigits: 2 })}
                            </span>
                          </div>
                          ...
                          <div className="flex justify-between">
                            ...
                            <span className="font-medium text-green-800">
                              R$ {calculationResult.monthly_amortization.toLocaleString('pt-BR', { minimumFractionDigits: 2 })}
                            </span>
                          </div>
                        </div>
                        ...
                        <div className="bg-blue-50 p-4 rounded-lg">
                          <div className="flex items-center space-x-2 mb-2">
                            ...
                            <span className="font-medium text-green-800">Primeira Vitória Conquistada!</span>
                          </div>
                          <p className="text-sm text-green-700">
                            Seus cálculos IFRS 16 foram gerados automaticamente. 
                      ...
                      <div className="bg-gray-50 p-6 rounded-lg text-center">
                        ...
                        <p className="text-gray-600 text-sm">
                          Preencha os dados do contrato e clique em "Calcular IFRS 16" para ver os resultados
                        </p>
                      </div>
                    )}
                  </div>
                    ...
                    <div className="space-y-3">
                      <label className="flex items-center space-x-3 p-3 bg-blue-50 rounded-lg">
                        <input
                          ...
                          onChange={(e) => setExplorationOptions(prev => ({ ...prev, showAdvancedFeatures: e.target.checked }))}
                          className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                        />
                        <div>
                          <div className="font-medium text-blue-900 text-sm">Recursos Avançados</div>
                          <div className="text-blue-700 text-xs">Modificações, impairment, disclosures</div>
                        </div>
                      </label>
                      ...
                      <label className="flex items-center space-x-3 p-3 bg-green-50 rounded-lg">
                        <input
                          ...
                          onChange={(e) => setExplorationOptions(prev => ({ ...prev, enableNotifications: e.target.checked }))}
                          className="h-4 w-4 text-green-600 focus:ring-green-500 border-gray-300 rounded"
                        />
                        <div>
                          <div className="font-medium text-green-900 text-sm">Notificações Proativas</div>
                          <div className="text-green-700 text-xs">Alertas de vencimento e conformidade</div>
                        </div>
                      </label>
                      ...
                      <label className="flex items-center space-x-3 p-3 bg-purple-50 rounded-lg">
                        <input
                          ...
                          onChange={(e) => setExplorationOptions(prev => ({ ...prev, scheduleDemo: e.target.checked }))}
                          className="h-4 w-4 text-purple-600 focus:ring-purple-500 border-gray-300 rounded"
                        />
                        <div>
                          <div className="font-medium text-purple-900 text-sm">Demo Personalizada</div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                      <div className="flex items-start space-x-3 p-3 bg-blue-50 rounded-lg">
                        ...
                        <div>
                          <div className="font-medium text-blue-900 text-sm">Criar Mais Contratos</div>
                          <div className="text-blue-700 text-xs">Adicione todos os seus contratos de leasing</div>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start space-x-3 p-3 bg-green-50 rounded-lg">
                        ...
                        <div>
                          <div className="font-medium text-green-900 text-sm">Relatórios Automáticos</div>
                          <div className="text-green-700 text-xs">Gere relatórios IFRS 16 profissionais</div>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start space-x-3 p-3 bg-purple-50 rounded-lg">
                        ...
                        <div>
                          <div className="font-medium text-purple-900 text-sm">Monitoramento Contínuo</div>
                          <div className="text-purple-700 text-xs">Acompanhe vencimentos e alertas</div>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="space-y-3">
                      <div className="flex items-start space-x-3 p-3 bg-yellow-50 rounded-lg">
                        ...
                        <div>
                          ...
                          <div className="text-yellow-700 text-xs">Sugestões inteligentes e automação</div>
                        </div>
                      </div>
                ...
                <div className="bg-gradient-to-r from-blue-50 to-purple-50 p-6 rounded-lg">
                  <div className="text-center">
                    ...
                    <p className="text-gray-600 mb-4">
                      Você completou o onboarding otimizado e já tem seu primeiro contrato calculado!
                    </p>
            ...
            <div className="flex space-x-3">
              ...
              >
                {isLoading ? (
                  ...
                  <>
                    <span>{currentStep === onboardingSteps.length - 1 ? 'Concluir' : 'Próximo'}</span>
