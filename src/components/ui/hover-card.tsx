...
export function HoverCard({
  ...
  const arrowClasses = {
    ...
    bottom:
      'bottom-full left-1/2 transform -translate-x-1/2 border-l-transparent border-r-transparent border-t-transparent border-b-border',
    ...
    right:
      'right-full top-1/2 transform -translate-y-1/2 border-t-transparent border-b-transparent border-l-transparent border-r-border',
  };
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className={cn(
              'absolute z-50 w-64 p-4 bg-popover border border-border rounded-lg shadow-lg',
              sideClasses[side],
              className
            )}
          >
