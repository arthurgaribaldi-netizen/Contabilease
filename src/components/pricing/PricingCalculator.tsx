      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-8'>
          ...
          <CardContent className='space-y-6'>
            <div className='space-y-2'>
              ...
              <Input
                ...
                step='0.5'
              />
              <p className='text-sm text-gray-500'>Tempo médio para calcular um contrato IFRS 16</p>
            </div>
            ...
            <div className='space-y-2'>
              ...
              <Input
                ...
                max='500'
              />
              <p className='text-sm text-gray-500'>Valor que você cobra por hora de trabalho</p>
            </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Resultados baseados nos dados inseridos</CardDescription>
          </CardHeader>
          <CardContent className='space-y-6'>
            {/* Time Saved */}
            <div className='p-4 bg-blue-50 rounded-lg'>
              ...
              <p className='text-sm text-blue-700'>Redução de 80% no tempo de cálculo</p>
            </div>
            ...
            <div className='p-4 bg-green-50 rounded-lg'>
              ...
              <p className='text-sm text-green-700'>De {inputs.errorRate}% para apenas 2%</p>
            </div>
              ...
              <tbody className='space-y-2'>
                <tr className='border-b'>
                  ...
                  <td className='py-3 px-4 text-center text-red-600'>
                    {inputs.currentTimePerContract}h
                  </td>
                  <td className='py-3 px-4 text-center text-green-600'>
                    {(inputs.currentTimePerContract * 0.2).toFixed(1)}h
                  </td>
                </tr>
                <tr className='border-b'>
