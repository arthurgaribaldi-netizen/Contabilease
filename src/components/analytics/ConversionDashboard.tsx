...
export default function ConversionDashboard() {
  ...
  const getConversionIcon = (rate: number, type: 'signup' | 'trial' | 'paid' | 'overall') => {
    ...
    const threshold = thresholds[type];
    if (rate >= threshold.excellent)
      return <ArrowTrendingUpIcon className='h-4 w-4 text-green-600' />;
    if (rate >= threshold.good) return <ArrowTrendingUpIcon className='h-4 w-4 text-blue-600' />;
    ...
    <div className='space-y-6'>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Retenção de usuários por período de cadastro</CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
        <Card>
          <CardHeader>
            ...
            <CardDescription>Visitantes → Clientes Pagos</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Valor gerado por período de cadastro</CardDescription>
          </CardHeader>
          <CardContent>
